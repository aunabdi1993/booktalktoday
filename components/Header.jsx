...
const pages = ['Listen', 'About', 'Contact'];
...
const Navbar = ({ menuOpen, setMenuOpen }) => (
  <div className="flex items-center justify-between p-4">
    <div className="flex items-center">
      <FireSvg />
      <a href="#home" className="text-xl font-bold no-underline text-white hover:text-gray-200">Book Talk Today Podcast</a>
    </div>
